...
sak10.href = saker[4].url;
sak10.querySelector("img").src = saker[4].bilde;
sak10.querySelector("h1").textContent = saker[4].tittel;
sak10.querySelector("h4").textContent = saker[4].stikktittel;

const sak11 = document.querySelector("#sak11");
sak11.href = saker[0].url;
sak11.querySelector("img").src = saker[0].bilde;
sak11.querySelector("h1").textContent = saker[0].tittel;
sak11.querySelector("h4").textContent = saker[0].stikktittel;
...
sak18.href = saker[2].url;
sak18.querySelector("img").src = saker[2].bilde;
sak18.querySelector("h1").textContent = saker[2].tittel;
sak18.querySelector("span").textContent = saker[2].tema;

const sak19 = document.querySelector("#sak19");
sak19.href = saker[3].url;
sak19.querySelector("img").src = saker[3].bilde;
sak19.querySelector("h1").textContent = saker[3].tittel;
sak19.querySelector("span").textContent = saker[3].tema;
...
sak20.querySelector("span").textContent = saker[4].tema;
...
sak21.querySelector("span").textContent = saker[0].tema;
...
sak22.querySelector("span").textContent = saker[1].tema;
...
sak23.querySelector("span").textContent = saker[2].tema;

const sak24 = document.querySelector("#sak24");
sak24.href = saker[3].url;
sak24.querySelector("h1").textContent = saker[3].tittel;
sak24.querySelector("span").textContent = saker[3].tema;
sak24.querySelector(".fri-byline-element").innerHTML = `
...
sak25.querySelector("span").textContent = saker[4].tema;
sak25.querySelector(".fri-byline-element").innerHTML = `
<img src="${saker[3].bilde}"></img>  
<div>
<p>${saker[3].forfatter}</p>
<b>${saker[3].stilling}</b>
...
sak26.querySelector("span").textContent = saker[0].tema;
sak26.querySelector(".fri-byline-element").innerHTML = `
<img src="${saker[3].bilde}"></img>  
<div>
<p>${saker[3].forfatter}</p>
<b>${saker[3].stilling}</b>
...
sak27.querySelector("span").textContent = saker[1].tema;
sak27.querySelector(".fri-byline-element").innerHTML = `
<img src="${saker[3].bilde}"></img>
<div>
<p>${saker[3].forfatter}</p>
<b>${saker[3].stilling}</b>
...
sak28.querySelector("span").textContent = saker[2].tema;
sak28.querySelector(".fri-byline-element").innerHTML = `
<img src="${saker[3].bilde}"></img>
<div>
<p>${saker[3].forfatter}</p>
<b>${saker[3].stilling}</b>
...
sak29.querySelector("span").textContent = saker[3].tema;
sak29.querySelector(".fri-byline-element").innerHTML = `
<img src="${saker[3].bilde}"></img>
<div>
<p>${saker[3].forfatter}</p>
<b>${saker[3].stilling}</b>
...
sak30.querySelector("span").textContent = saker[4].stikktittel;
...
sak31.querySelector("span").textContent = saker[0].stikktittel;
...
sak32.querySelector("span").textContent = saker[1].stikktittel;
...
sak33.querySelector("span").textContent = saker[2].stikktittel;

const sak34 = document.querySelector("#sak34");
sak34.href = saker[3].url;
sak34.querySelector("img").src = saker[3].bilde;
sak34.querySelector("h1").textContent = saker[3].tittel;
sak34.querySelector("span").textContent = saker[3].stikktittel;

const sak35 = document.querySelector("#sak35");
sak35.href = saker[4].url;
sak35.querySelector("img").src = saker[4].bilde;
sak35.querySelector("h1").textContent = saker[4].tittel;
sak35.querySelector("span").textContent = saker[4].stikktittel;

const sak36 = document.querySelector("#sak36");
sak36.querySelector("img").src = saker[0].bilde;
sak36.querySelector("h1").textContent = saker[0].tittel;
sak36.querySelector("span").textContent = saker[0].stikktittel;

const sak37 = document.querySelector("#sak37");
sak37.querySelector("img").src = saker[1].bilde;
sak37.querySelector("h1").textContent = saker[1].tittel;
sak37.querySelector("span").textContent = saker[1].stikktittel;

const sak38 = document.querySelector("#sak38");
sak38.querySelector("img").src = saker[2].bilde;
sak38.querySelector("h1").textContent = saker[2].tittel;
sak38.querySelector("span").textContent = saker[2].stikktittel;

const sak39 = document.querySelector("#sak39");
sak39.querySelector("img").src = saker[3].bilde;
sak39.querySelector("h1").textContent = saker[3].tittel;
sak39.querySelector("span").textContent = saker[3].stikktittel;

const sak40 = document.querySelector("#sak40");
sak40.querySelector("img").src = saker[4].bilde;
sak40.querySelector("h1").textContent = saker[4].tittel;
sak40.querySelector("span").textContent = saker[4].stikktittel;

const sak41 = document.querySelector("#sak41");
sak41.querySelector("img").src = saker[0].bilde;
sak41.querySelector("h1").textContent = saker[0].tittel;
sak41.querySelector("span").textContent = saker[0].stikktittel;

const sak42 = document.querySelector("#sak42");
sak42.querySelector("img").src = saker[1].bilde;
